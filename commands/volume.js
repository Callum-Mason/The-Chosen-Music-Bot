...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if (!parseInt(args[0])) return client.sendTime(message.channel, `**Please choose a number between** \`1 - 1000\``);
        ...
        options: [
            {
                ...
                type: 4,
                required: false,
                description: "Enter a volume from 1-1000. Default is 100.",
            },
        ],
    /**
     *
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (!vol || vol < 1 || vol > 1000) return client.sendTime(interaction, `**Please choose a number between** \`1 - 100\``);
            player.setVolume(vol);
